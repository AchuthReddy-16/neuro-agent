#!/usr/bin/env python3
"""Run multimodal RLVR checkpoint evaluation (Stage F.2)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run multimodal RLVR evaluation")
...
def main() -> None:
    ...
    output_cfg = cfg.get("eval_output", {"dir": "results/multimodal_rlvr_eval"})
    ...
    print(f"Evaluating RLVR checkpoint on {len(examples)} examples...")
