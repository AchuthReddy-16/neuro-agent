#!/usr/bin/env python3
"""Run base-model held-out evaluation for Qwen3-4B (Stage C)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run base Qwen held-out evaluation")
    parser.add_argument(
        "--config",
        type=Path,
        default=CONFIGS_DIR / "eval.yaml",
