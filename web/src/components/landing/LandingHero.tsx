  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden bg-surface landing-vignette">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 pb-20">
        <div className="max-w-2xl text-center space-y-7 animate-fade-in">
          ...
          <p className="text-base md:text-lg text-secondary max-w-xl mx-auto leading-relaxed">
            Deterministic EEG tools, evidence-grounded answers, vision when needed,
            verification, and optimized inference — in one scientific workstation.
          </p>
          ...
          <ul className="pt-6 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[11px] text-muted font-mono">
            <li>Text · Qwen3-4B</li>
      ...
      <footer className="relative z-10 text-center pb-8 text-[11px] text-muted">
        Frontend demo mode until backend is connected
      </footer>
    </div>
  );
}
